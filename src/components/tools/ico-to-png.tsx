...
export default function ico_to_png_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".ico" onFilesSelected={handleFile} label="Drop an image to convert ico to png" description="Supports ICO formats" />
      ) : (
