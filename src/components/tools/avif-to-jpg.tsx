...
export default function avif_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".avif" onFilesSelected={handleFile} label="Drop an image to convert avif to jpg" description="Supports AVIF formats" />
      ) : (
