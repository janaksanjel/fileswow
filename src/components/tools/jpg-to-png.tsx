...
export default function jpg_to_png_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".jpg,.jpeg" onFilesSelected={handleFile} label="Drop an image to convert jpg to png" description="Supports JPG,JPEG formats" />
      ) : (
