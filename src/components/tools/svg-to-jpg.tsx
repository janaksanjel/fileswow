...
export default function svg_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".svg" onFilesSelected={handleFile} label="Drop an image to convert svg to jpg" description="Supports SVG formats" />
      ) : (
