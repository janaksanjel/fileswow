...
export default function tiff_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".tiff,.tif" onFilesSelected={handleFile} label="Drop an image to convert tiff to jpg" description="Supports TIFF,TIF formats" />
      ) : (
