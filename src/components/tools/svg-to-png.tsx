...
export default function svg_to_png_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".svg" onFilesSelected={handleFile} label="Drop an image to convert svg to png" description="Supports SVG formats" />
      ) : (
