...
export default function png_to_webp_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".png" onFilesSelected={handleFile} label="Drop an image to convert png to webp" description="Supports PNG formats" />
      ) : (
