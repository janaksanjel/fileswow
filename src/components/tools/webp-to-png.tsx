...
export default function webp_to_png_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".webp" onFilesSelected={handleFile} label="Drop an image to convert webp to png" description="Supports WEBP formats" />
      ) : (
