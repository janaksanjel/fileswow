...
export default function png_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".png" onFilesSelected={handleFile} label="Drop an image to convert png to jpg" description="Supports PNG formats" />
      ) : (
