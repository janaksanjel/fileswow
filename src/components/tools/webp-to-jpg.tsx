...
export default function webp_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".webp" onFilesSelected={handleFile} label="Drop an image to convert webp to jpg" description="Supports WEBP formats" />
      ) : (
