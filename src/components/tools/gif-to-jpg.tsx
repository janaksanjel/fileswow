...
export default function gif_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".gif" onFilesSelected={handleFile} label="Drop an image to convert gif to jpg" description="Supports GIF formats" />
      ) : (
