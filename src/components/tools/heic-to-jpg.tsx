...
export default function heic_to_jpg_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".heic,.heif" onFilesSelected={handleFile} label="Drop an image to convert heic to jpg" description="Supports HEIC,HEIF formats" />
      ) : (
