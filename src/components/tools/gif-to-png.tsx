...
export default function gif_to_png_Tool({ onProcessing, onError }: ToolUIProps) {
  ...
  return (
    <div className="space-y-6">
      {!file ? (
        <DropZone accept=".gif" onFilesSelected={handleFile} label="Drop an image to convert gif to png" description="Supports GIF formats" />
      ) : (
